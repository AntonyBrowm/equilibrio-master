...
export const DatosThree = ({        CostoFijo,
CostoVariable1,
CostoVariable2,
CostoVariable3,
CostoVariable4,
...
Ventas4,})=>{
    ...
    const SumaVT=(VentasT1+VentasT2+VentasT3+VentasT4);
    ...
    const CMPP=(CMP1+CMP2+CMP3+CMP4);
    ...
    return(
        <div style={{ height: 640, width: '100%' }}>
          ...
          Margen de utilidad= {CMarg1+CMarg2+CMarg3+CMarg4}
               </div>
       </div>
    );
}

export default DatosThree;