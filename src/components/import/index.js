  ...
  const [results, setResults] = useState([]); 
    ...
    >
      ...
      <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 12 }}>
        ...
        <Grid item xs={2} sm={4} md={4}>PRODUCTO 5</Grid>
        ...
        <Grid item xs={2} sm={4} md={4}><Field   type="number" id="CostoVariable5" name="CostoVariable5" placeholder="Ingrese el dato" /></Grid>
        ...
        <Grid item xs={2} sm={4} md={4}><Field   type="number" id="Precio5" name="Precio5" placeholder="Ingrese el dato" /></Grid>
        ...
        <Grid item xs={2} sm={4} md={4}><Field   type="number" id="Ventas5" name="Ventas5" placeholder="Ingrese el dato" /></Grid>
        <Grid item xs={2} sm={4} md={4}><Field   type="number" id="UnidadesDeseadas" name="UnidadesDeseadas" placeholder="Ingrese Unidades Deseadas" /></Grid>
      </Grid>
    </Box>
